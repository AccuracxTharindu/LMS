                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">							
							...
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <div class="pull-left">
                                    <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;Total Amount of Penalty:&nbsp;<?php echo "LKR ".$count_penalty_row['sum(book_penalty)'].".00"; ?></div></div>
                                </div>
...
?>
							...
							<!---	<td style="text-transform: capitalize"><?php // echo $return_row['author']; ?></td>
								...
								<?php
								 if ($return_row['book_penalty'] != 'No Penalty'){
									 echo "<td class='alert alert-warning' style='width:100px;'>LKR ".$return_row['book_penalty'].".00</td>";
								 }else {
