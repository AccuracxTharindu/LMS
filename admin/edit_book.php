                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-4">
										...
										<?php
										$resultC= mysqli_query($con,"select * from category") or die (mysqli_error());
										while ($rowC= mysqli_fetch_array ($resultC) ){
										$id=$rowC['category_id'];
										?>
                                            <option value="<?php echo $rowC['category_id']; ?>"><?php echo $rowC['classname']; ?></option>
										<?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <!--<input type="text" name="accessionNo" id="last-name2" value="<?php echo $row['Accession_No']; ?>" class="form-control col-md-7 col-xs-12" disabled="disabled">-->
                                        <input type="hidden" name="accessionNo" id="last-name2" value="<?php echo $row['Accession_No']; ?>" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
...
book_pub='$book_pub', publisher_name='$publisher_name', isbn='$isbn', copyright_year='$copyright_year', status='$status', remarks='$remark' ,Sub_Category='$subCat', Class_No='$classNo', Library='$library', Location='$location', Accession_No='$accessionNo', Edition='$edition', Source='$source', Pages='$pages', Price='$price' WHERE book_id = '$id' ")or die(mysqli_error());
