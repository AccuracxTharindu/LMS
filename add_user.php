                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" name="school_number" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-4">
                                        <select name="level" class="select2_single form-control" required="required" tabindex="-1" >
                                        	<option value="Grade 7">Grade 1</option>
                                            <option value="Grade 8">Grade 2</option>
                                            <option value="Grade 9">Grade 3</option>
                                            <option value="Grade 10">Grade 4</option>
                                            <option value="Grade 7">Grade 5</option>
                                            <option value="Grade 8">Grade 6</option>
                                            <option value="Grade 7">Grade 7</option>
                                            <option value="Grade 8">Grade 8</option>
                                            <option value="Grade 9">Grade 9</option>
                                            <option value="Grade 10">Grade 10</option>
                                            <option value="Grade 10">Grade 11</option>
                                            <option value="Grade 9">Teacher</option>
